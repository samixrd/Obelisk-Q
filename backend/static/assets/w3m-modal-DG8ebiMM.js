import{R as c,_ as k,ai as le,H as pe,e as v,f as V,h as f,i as g,k as d,n as l,O as $,G as H,P as u,g as me,x as w,v as B,L as U,ae as fe,a4 as F,J as K,X as A,A as M,p as we,S as E,a0 as z,ab as oe,T as be,U as ce,aj as ge,ak as ye}from"./index-8QVUqvBt.js";import{P as D}from"./index-mUySeYMw.js";import{S as ve}from"./SwapController-BWzEyFG8.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
