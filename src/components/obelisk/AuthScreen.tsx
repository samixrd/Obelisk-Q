  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 50%, hsl(220 50% 8% / 0.6), transparent 80%)",
        }}
      />
      <div
        aria-hidden
        ...
        style={{
          background:
            "radial-gradient(ellipse, hsl(104 60% 60% / 0.04) 0%, transparent 70%)",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(145deg, rgba(255,255,255,0.035) 0%, rgba(255,255,255,0.008) 100%), rgba(8,8,10,0.7)",
          backdropFilter: "blur(48px) saturate(180%)",
          WebkitBackdropFilter: "blur(48px) saturate(180%)",
          border: "1px solid rgba(255,255,255,0.10)",
          boxShadow:
            "0 1px 0 0 rgba(255,255,255,0.05) inset, 0 50px 100px -30px rgba(0,0,0,0.95), 0 0 0 1px rgba(255,255,255,0.06)",
        }}
      >
        {/* Top accent line */}
        <div
        ...
        <div className="p-10">
          ...
          >
            ...
            <AuthButton
              ...
              sublabel="MetaMask · WalletConnect · Ledger"
              accent
            />
          </motion.div>
            ...
            <div className="flex items-center gap-2">
              <span
                ...
                style={{
                  ...
                  boxShadow: "0 0 6px hsl(104 100% 68% / 0.7)",
...
function AuthButton({ onClick, icon, label, sublabel, accent }: AuthButtonProps) {
  return (
    <motion.button
      onClick={onClick}
      whileHover={{ y: -2 }}
      ...
      className="group w-full flex items-center gap-4 px-5 py-4 text-left transition-all duration-500"
      style={{
        background: accent
    ...
    >
      <span className="flex-shrink-0 opacity-70 group-hover:opacity-100 transition-opacity duration-400">
        {icon}
      </span>
      <div className="flex-1 min-w-0">
        <p
          className="text-[13px] text-white/85 group-hover:text-white transition-colors duration-400"
      ...
      <svg viewBox="0 0 16 16" width="10" height="10" fill="none" className="text-white/20 group-hover:text-white/50 transition-colors duration-400 flex-shrink-0">
