      ...
      <div className="col-span-12 lg:col-span-4 space-y-6">
        <div className="glass-card rounded-2xl p-6 md:p-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="h-12 w-12 rounded-full bg-foreground/5 border border-foreground/10 flex items-center justify-center text-lg font-medium text-foreground/60">
              JD
            </div>
            <div>
              <p className="text-base text-foreground font-medium" style={{ fontFamily: "'Inter', sans-serif" }}>Jane Doe</p>
